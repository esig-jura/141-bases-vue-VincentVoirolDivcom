...
const nbCaracteres = computed(() => userInput.value.length);

// Mise à zéro de la saisie si elle dépasse la longueur maximale
...
watch(userInput, (newValue) => {
  // Vérification de la présence de "Pokémon" (insensible à la casse)
